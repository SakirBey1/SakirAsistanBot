...
Join my [news channel](https://t.me/KonseyAnaGrup) to get information on all the latest updates.
"""
...
""".format(dispatcher.bot.first_name, "" if not ALLOW_EXCL else "If you have any bugs or questions on how to use me, have a look at my [Group](https://t.me/KonseyAnaGrup), or head to @Sakirhackofficial99.")

DONATE_STRING = """Heya, glad to hear you want to donate!
It took lots of work for [my creator](t.me/SonOfLars) to get me to where I am now, and every donation helps \
motivate him to make me even better. All the donation money will go to a better VPS to host me, and/or beer \
(see his bio!). He's just a poor student, so every little helps!
There are two ways of paying him; [PayPal](https://t.me/Sakihackofficial99), or [Monzo](https://t.me/Sakihackofficial99)."""
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Hello all Join @Sakirhackofficial99.")
